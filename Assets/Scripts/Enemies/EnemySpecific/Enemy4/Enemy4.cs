...
public class Enemy4 : Entity, ICollisionHandler
{
    ...
    public E4_EngagedState engagedState { get; private set; }
    ...
    public override void Awake()
    {
        ...
        engagedState = new E4_EngagedState(this, stateMachine, "engage", engagedStateData, this);
