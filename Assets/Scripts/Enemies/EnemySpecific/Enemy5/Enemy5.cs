...
public class Enemy5 : Entity, ICollisionHandler
{
    ...
    public E5_EngagedState engagedState { get; private set; }
    ...
    public override void Awake()
    {
        ...
        engagedState = new E5_EngagedState(this, stateMachine, "engage", engagedStateData, this);
