...
public class E7_MeleeAttackState : MeleeAttackState
{
    ...
    public E7_MeleeAttackState(Entity etity, FiniteStateMachine stateMachine, string animBoolName, Transform attackPosition, D_MeleeAttack stateData, Enemy7 enemy, GameObject attackCollider) : base(etity, stateMachine, animBoolName, attackPosition, stateData)
    {
        this.enemy = enemy;
