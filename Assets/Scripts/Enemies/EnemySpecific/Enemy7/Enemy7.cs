...
public class Enemy7 : Entity, ICollisionHandler
{
    ...
    public E7_EngagedState engagedState { get; private set; }
    ...
    public override void Awake()
    {
        ...
        meleeAttackState = new E7_MeleeAttackState(this, stateMachine, "meleeAttack", meleeAttackPosition, meleeAttackStateData, this, meleeAttackCollider);
        ...
        engagedState = new E7_EngagedState(this, stateMachine, "engage", engagedStateData, this);
